import React__default, { createContext, Fragment, useState, useRef, useEffect, useContext, lazy, Suspense } from 'react';
    ...
    const signIn = async (userID, password) => {
        ...
        try {
            ...
            if (resData.token) {
                ...
                g.mounted = true;
                const [validTokenRes, { hash }, { fromUtf8 }] = await Promise.all([tokenPost(POST_TYPES.VALID_TOKEN), import('./sha256-e0894fe4.js').then(function (n) { return n.s; }), import('./index-10b0f241.js')]);
      ...
      if (g.ebconfig.tt && g.ebconfig.integration.split("-")[0].toUpperCase() !== "PROJECT") {
        ...
        if (cacheRefreshToken) {
          ...
          const [refreshTokenRes, {
            ...
            token: g.token,
            getUserID: true
          }), import('./sha256-e0894fe4.js').then(function (n) { return n.s; }), import('./index-10b0f241.js')]);
...
const Auth = lazy(() => import('./Auth-25393280.js').then(function (n) { return n.A; }));
...
export { EasybaseProvider as E, _extends as _, commonjsGlobal as a, createCommonjsModule as c, getDefaultExportFromCjs as g, index as i, useEasybase as u };
//# sourceMappingURL=index-775190d4.js.map
