...
var Form = Auth.styled.form(function (props) {
...
var Label = Auth.styled.label(function (props) {
  return index._extends({
    display: "none",
    fontFamily: "inherit"
...
var TextFieldRoot = Auth.styled.div(function (props) {
  return index._extends({
    position: 'relative',
    width: '100%',
    maxWidth: '100%',
...
var TextField = Auth.styled.input(function (props) {
  return index._extends({
    display: "block",
    width: '100%',
    background: '0 0',
...
var Bar = Auth.styled.div(function (props) {
...
var HeaderText = Auth.styled.h1(function (props) {
  return index._extends({
    fontFamily: "inherit",
    fontSize: 24,
    fontWeight: 500,
...
var TextButton = Auth.styled.button(function (props) {
  return index._extends({
    cursor: "pointer",
    color: '#635bff',
    whiteSpace: 'nowrap',
...
var SecondaryButton = Auth.styled(TextButton$1)(function (props) {
  return index._extends({
    margin: '15px'
...
var SubmitButtonRoot = Auth.styled.div(function (props) {
  return props.theme.submitButtonRoot ? props.theme.submitButtonRoot : {};
});
var SubmitButton = Auth.styled.button(function (props) {
  return index._extends({
    position: 'relative',
    border: "none",
...
function useSubscribe(props) {
    const _props = React__namespace.useRef(props);
...
//# sourceMappingURL=index.esm-f4de5e43.js.map
