var index$1 = require('./index-04d24c4d.js');
...
var DefaultSignIn = React.lazy(function () {
  return Promise.resolve().then(function () { return require('./SignIn-bcfe5c5b.js'); });
});
var DefaultSignUp = React.lazy(function () {
  return Promise.resolve().then(function () { return require('./SignUp-3f867ad4.js'); });
});
var DefaultForgotPassword = React.lazy(function () {
  return Promise.resolve().then(function () { return require('./ForgotPassword-8138fe97.js'); });
});
function Auth (_ref) {
  ...
  if (isUserSignedIn()) {
    ...
    return React__default["default"].createElement(Fe, {
      theme: themeVal
...
exports.toast = toast;
//# sourceMappingURL=Auth-dec80812.js.map
